...
const Gallery = () => {
  ...
  return (
    <>
      <h1 style={{ textAlign: "center", color: "#4dbf1c",marginTop:"4%" }}>Ev Components and Photos</h1>
            ...
            <>
              <div class="Gallerycard">
                <div className='GalleryImg'>
                  <img src={ComponentImage} alt="Retrofitment kit" style={{ width: 250, height: 276.312 }} />
                </div>
                <hr />
                <h3 >{ComponentName}</h3>
              </div>
